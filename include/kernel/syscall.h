...
typedef enum {
	...
	SYSCALL_PROCESS_RUN_WITH_PRIORITY, // new syscall: schedule a process with priority
	SYSCALL_PROCESS_FORK,
	SYSCALL_PROCESS_EXEC,
	SYSCALL_PROCESS_SELF,
	SYSCALL_PROCESS_PARENT,
	SYSCALL_PROCESS_PRIORITY, // new syscall: get priority of current process
	...
	SYSCALL_DESTROY_NAMED_PIPE, // new syscall: destroy a named pipe
